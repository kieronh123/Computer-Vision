        ...
        if self.green_detected==True:
            ...
            if cv2.contourArea(cgreen) > 1:
                if cxgreen < 315:
                    ...
                    if cv2.contourArea(cgreen) < 7000:
                        self.desired_velocity.linear.x = 0.2
                    elif cv2.contourArea(cgreen) > 8000:
                        self.desired_velocity.linear.x = -0.2
                    elif cv2.contourArea(cgreen) > 7000 or cv2.contourArea(cgreen) < 8000:
